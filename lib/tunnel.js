...
Tunnel.prototype.close = function(done) {
  ...
  if (this.connected === false) {
    debug("Not currently connected, nothing to close");
  ...
  return this.connection.unforwardIn("127.0.0.1", this.options.forwardPort, function(err) {
